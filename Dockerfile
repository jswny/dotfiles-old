...
# Pinned versions
ARG LOCALES_VERSION='2.32-*'
ARG MAN_DB_VERSION='2.9.*'
ARG SUDO_VERSION='1.9.*'
ARG GOSU_VERSION='1.12-*'
ARG BUILD_ESSENTIAL_VERSION='12.8*'
ARG MAKE_VERSION='4.3-*'
ARG CA_CERTIFICATES_VERSION='20210119~20.10.*'
ARG CURL_VERSION='7.68.*'
ARG FILE_VERSION='1:5.38-*'
ARG GIT_VERSION='1:2.27.*'
ARG PATCH_VERSION='2.7.*'
